...
RUN \
  ...
  apt-get install -y --no-install-recommends \
          ...
          at git \
          apache2 libapache2-mod-wsgi python-django at ssl-cert python-dev python-twisted python2.7-twisted python2.7-twisted-bin python2.7-twisted-core python-twisted-runner \
        ;
